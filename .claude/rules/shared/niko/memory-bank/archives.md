---
paths:
  - memory-bank/archive/**/*.md
---

## From: .cursor/rules/shared/niko/memory-bank/archives.mdc
...
Archives are categorized into the following kinds:
...
## METADATA
- **Task ID**: [task-id]
- **Complexity**: [Task Complexity Level (e.g., Level 2, Level 3)]
...
[Describe verification steps taken: how was this work tested or validated? List manual checks, test runs, use of `/qa`, etc.]
