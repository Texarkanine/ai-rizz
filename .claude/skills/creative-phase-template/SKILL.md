---
name: "creative-phase-template"
description: "Invoke with /creative-phase-template"
...
5. **Step 5: Output Document** - Write to `memory-bank/creative/creative-[question-name].md`. The format must include at minimum:
