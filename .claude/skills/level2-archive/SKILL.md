---
name: "level2-archive"
description: "Invoke with /level2-archive"
...
The archive format is defined in `.claude/rules/shared/niko/memory-bank/archives.md` - follow that format. Keep it concise for Level 2: a brief summary, the key files changed, what was learned. Inline relevant content from the reflection file directly - the reflection file is about to be deleted.
