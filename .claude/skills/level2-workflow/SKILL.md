...
description: "Invoke with /level2-workflow"
...
To execute a phase for a level 2 task, read and follow the instructions in the appropriate location:

- **Level 2 Plan Phase**: Load `.claude/skills/level2-plan/SKILL.md`
- **Level 2 Preflight Phase**: Invoke the `niko-preflight` skill
- **Level 2 Build Phase**: Load `.claude/skills/level2-build/SKILL.md`
- **Level 2 QA Phase**: Invoke the `niko-qa` skill
- **Level 2 Reflect Phase**: Load `.claude/skills/level2-reflect/SKILL.md`
- **Level 2 Archive Phase**: Load `.claude/skills/level2-archive/SKILL.md`
