---
name: "level3-archive"
description: "Invoke with /level3-archive"
...
The archive format is defined in `.claude/rules/shared/niko/memory-bank/archives.md` - follow that format. For Level 3, this means full treatment:
