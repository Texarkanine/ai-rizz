---
name: "level3-build"
description: "Invoke with /level3-build"
...
- Confirm `memory-bank/.preflight_status` exists and contains `PASS` or `PASS WITH ADVISORY`
...
4. Run any build or packaging processes to confirm that no regressions
...
- **Plan deficiency**: Return to `/plan` to revise the implementation approach.
- **Creative decision invalid**: Return to `/plan` - the relevant open question needs re-exploration.
