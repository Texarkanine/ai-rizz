...
- **Architecture** (`.claude/skills/creative-phase-architecture/SKILL.md`): The question is about system structure - how components relate, what patterns to use, how to organize modules, where boundaries should be, how data flows between subsystems.

- **Algorithm** (`.claude/skills/creative-phase-algorithm/SKILL.md`): The question is about logic and computation - how to solve a specific problem, what data structures to use, how to handle complex transformations, performance-sensitive processing.

- **UI/UX** (`.claude/skills/creative-phase-uiux/SKILL.md`): The question is about user-facing design - how to present information, interaction flows, visual layout, accessibility, style guide decisions.

- **Generic** (`.claude/skills/creative-phase-generic/SKILL.md`): The question doesn't fit the above categories - naming conventions, testing strategies, process decisions, tooling choices, configuration approaches, or anything else not explicitly associated with a specific creative phase type.
