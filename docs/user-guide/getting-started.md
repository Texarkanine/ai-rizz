...
All examples below use the public reference repo at `Texarkanine/.cursor-rules`. If you use a different source repo, replace the URL and item names with entries from your `ai-rizz list` output after init.
