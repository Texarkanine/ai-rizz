...
| Last Check | 2026-01-25T22:14:56Z |
| Last Push | 2026-01-25T22:30:00Z |
| Last CodeRabbit Response | 2026-01-25T22:14:56Z |
| Rate Limit Until | |
...
- [x] ID: 2725969344 - Use POSIX-portable grep -E instead of escaped \| in test_ruleset_commands.test.sh - FIXED (this commit)
- [x] ID: 2725969345 - Manifest variable consistency (LOCAL_MANIFEST_FILE vs TEST_LOCAL_MANIFEST_FILE) - NOT A BUG (variables are correctly set by cmd_init; TEST_GLOBAL_MANIFEST_FILE doesn't exist in common.sh)
- [x] ID: nitpick-variable-prefixes - Function-specific prefixes for output/exit_code variables - ACKNOWLEDGED (low priority style suggestion; tests pass)
...
## Fix History
### Round 3 - 2026-01-25T22:14:56Z
- Comments: 2725969344, 2725969345, nitpick-variable-prefixes
- Resolution: Fixed grep POSIX portability (use -E flag instead of escaped \|); acknowledged manifest variable issue as non-bug; acknowledged nitpick
- Files: tests/unit/test_ruleset_commands.test.sh (lines 298, 334, 370)
...
- CodeRabbit comment 2725969345 suggested using TEST_GLOBAL_MANIFEST_FILE but this constant doesn't exist in common.sh; LOCAL_MANIFEST_FILE and GLOBAL_MANIFEST_FILE are correctly set by cmd_init
